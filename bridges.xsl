	...
	<xsl:template match="cable">
		...
		<xsl:attribute name="border">1</xsl:attribute>
			<tr style='height:10.0pt'>
				<td><xsl:attribute name="colspan">6</xsl:attribute><xsl:attribute name="align">center</xsl:attribute>HOJA DE PUENTES</td>
			</tr>
			<tr style='height:10.0pt'>
				...
				<td><xsl:attribute name="colspan">1</xsl:attribute>
				HOJA  DE 
				</td>
			</tr>
			<tr>
